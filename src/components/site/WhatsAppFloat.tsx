export function WhatsAppFloat() {
  return (
    ...
    >
      <span className="absolute inset-0 -z-10 rounded-full bg-[#25D366] animate-pulse-ring" aria-hidden />
      <span className="absolute inset-0 -z-10 rounded-full bg-[#25D366] animate-pulse-ring [animation-delay:1s]" aria-hidden />
