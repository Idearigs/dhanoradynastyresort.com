      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary-dark"
          >
            Try again
          </button>
          <a
  ...
  head: () => ({
    meta: [
      ...
      { title: "Dhanora Dynasty Resort — Luxury Heritage in Anuradhapura" },
      {
        name: "description",
        content:
          "Experience the timeless tranquility of Rajarata ancient kingdom at Dhanora Dynasty Resort — a luxury heritage retreat in Anuradhapura, Sri Lanka.",
      },
      { name: "author", content: "Dhanora Dynasty Resort" },
